...
namespace Microsoft { namespace MSR { namespace CNTK {
    ...
    public:
        ...
        // Randomize by spray original sequences over a window of "m_randomizationRange" samples.
        void RandomizeUsingWindowInSamples();

        // Randomize by spray original sequences over a window of "m_randomizationRange" of chunks.
